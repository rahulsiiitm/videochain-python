...
\begin{document} 	
	\begin{titlepage} 
		...
		{\scshape\Large Dr. Jennyl Thiyam}
...
\begin{center}
	\thispagestyle{empty}
		...
		\par\noindent\rule{\textwidth}{0.4pt}
			...
			Assistant Professor
			\hspace*{0pt}\hfill Contact No: +91 xxxxxxx\\[2cm]
			...
			\hspace*{2.5in}\textbf{(Dr. Jennyl Thiyam)}\\[0.5cm]
...
\end{center}
\vspace{2cm}
I would like to express my sincere gratitude to my supervisor, \textbf{Dr. Jennyl Thiyam}, for their invaluable guidance, constant encouragement, and insightful feedback throughout the development of this project. Their expertise in the domain and constructive criticism have been instrumental in shaping the technical architecture of VidChain.
