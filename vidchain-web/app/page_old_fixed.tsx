...
// Node indicator pill ΓÇö driven by real liveStatus substrings from backend
function NodePill({
  label, active, color,
...
// Pipeline stage row ΓÇö status driven by liveStatus string matching
function StageRow({
  stage, liveStatus,
  ...
  return (
    <div className="flex items-center gap-2 py-1">
      ...
      <span className={cn(
        ...
        {isRunning ? "active" : isDone ? "done" : isError ? "err" : "ΓÇö"}
      </span>
    </div>
  );
}

// ΓöÇΓöÇ Main Dashboard ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
export default function SpideyChainDashboard() {
  ...
  // Pipeline stages ΓÇö nodeKey must match actual substrings from backend liveStatus
  ...
  // ΓöÇΓöÇ Derived Neural State ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
  ...
  // Node active flags ΓÇö driven directly by liveStatus string from backend
  ...
  // ΓöÇΓöÇ Cognitive Bridge: Live Status Polling ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
  useEffect(() => {
  ...
  // ΓöÇΓöÇ API ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
  ...
  const exportForensicReport = () => {
    ...
    const header = [
      `# ≡ƒò╡∩╕ÅΓÇìΓÖé∩╕Å VIDCHAIN FORENSIC INTELLIGENCE REPORT`,
      `# ----------------------------------------`,
    ...
    const body = messages.map(m =>
      `### ${m.sender === "baburao" ? "≡ƒñû B.A.B.U.R.A.O." : m.sender === "system" ? "ΓÜÖ SYSTEM" : "≡ƒæñ OPERATOR"} ┬╖ ${m.timestamp}\n\n${m.text}`
    ).join("\n\n---\n\n");
  ...
  // ΓöÇΓöÇ Ingestion ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
  ...
  // ΓöÇΓöÇ Query ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
  ...
  // ΓöÇΓöÇ Video helpers ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
          ...
          components={{
            ...
            li: ({ children }) => (
              <li className="flex gap-2 text-[11px] text-gray-300">
                <span className="text-spider-red font-black">ΓÇó</span>
  ...
  return (
    <div className="flex h-screen bg-background font-sans overflow-hidden text-foreground relative">
      ...
      {/* ΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉ LEFT SIDEBAR ΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉ */}
      <motion.aside
      ...
      {/* ΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉ MAIN PANEL ΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉ */}
        ...
        <div className="shrink-0 h-14 border-b border-stark-border bg-stark-navy/5 backdrop-blur-md flex items-center justify-between px-5 gap-4">
          ...
          <div className="flex items-center gap-3 flex-1 min-w-0">
            <div className="flex flex-col min-w-0">
              ...
              {activeSession && (
                <span className="text-[7px] text-gray-700 font-mono leading-tight">{activeSession.id.slice(0, 14)}ΓÇª</span>
              )}
            </div>
            {/* Live status pill ΓÇö only visible when pipeline is running */}
          ...
          <div className="flex items-center gap-2 shrink-0">
            ...
            <div className="flex items-center gap-2">
              <div className="relative group">
                ...
                <input type="text" placeholder="Video path or URLΓÇª"
                  value={videoPath}
              ...
              >
                ...
                {isIngesting ? "ScanningΓÇª" : "Scan"}
              </button>
            </div>
          </div>
        </div>

        {/* Search bar ΓÇö shown once there are enough messages */}
        {messages.length > 3 && (
          <div className="shrink-0 border-b border-stark-border/40 bg-background/60 px-5 py-1.5 flex items-center gap-3">
            ...
            <input type="text" placeholder="Search conversationΓÇª"
              value={searchFilter}
          ...
          <div className="max-w-2xl mx-auto space-y-7">
            ...
            {isLoadingSession && (
              <div className="flex items-center gap-3 text-gray-700">
                ...
                <span className="text-[9px] uppercase tracking-widest font-bold">Loading sessionΓÇª</span>
              </div>
            )}
              ...
              {filteredMessages.map(msg => (
                ...
                >
                  ...
                  <div className={cn(
                    ...
                    {/* Confidence meter ΓÇö AI messages only */}
            ...
            {isQuerying && (
              ...
              >
                ...
                <span className="text-[8px] text-spider-red font-black uppercase tracking-[0.3em]">ReconstructingΓÇª</span>
      ...
      {/* ΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉ RIGHT TELEMETRY PANEL ΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉ */}
      <motion.aside
      ...
      >
        ...
        {!rightCollapsed && (
          <>
            {/* ΓöÇΓöÇ Engine Nodes (real-time from liveStatus) ΓöÇΓöÇ */}
            ...
            {/* ΓöÇΓöÇ Pipeline Progress ΓöÇΓöÇ */}
            <div className="p-3 border-b border-stark-border shrink-0">
            ...
            {/* ΓöÇΓöÇ Embedded Video Player ΓöÇΓöÇ */}
            <AnimatePresence>
              {activeVideoPath && (
                <motion.div
